...
/**
 * HttpRequest
 * web server send POST and GET request, contains two methods: readContentFromGet and readContentFromPost.
 * 
 */
public class HttpRequest {
	
	/**
	 * HttpRequest.readContentFromGet()
	 * @param GET_URL
	 */
	...
	public static String MyDeleteMethod(String url, final String content) {
		...
		try {
			...
			strResult = "failed to connect controller";
			e.printStackTrace();
		}
