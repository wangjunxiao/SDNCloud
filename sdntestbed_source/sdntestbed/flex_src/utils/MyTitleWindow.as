package utils
{
	...
	public class MyTitleWindow extends TitleWindow
	{
		...
		//adjust TitleWindow size other:0 top:1 right:2 left:7 bottom:4
		private var mouseMargin:Number=4;//response scope
		// set the cursor position, right up: 3; right down: 6; left down: 11; left up: 8
...
//				dispatchEvent(new Event(TITLEWINDOW_RESIZE));
		...
		private function winMinSize():void{
			this.width = 200;
			//height<31 titleBar can not show
			this.height = 31;  
			this.x  = 0;
